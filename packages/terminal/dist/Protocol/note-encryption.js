...
class SaplingNotePlaintext {
     ...
     */
    cm(pk_d) {
        const hash = (0, blake3_js_1.blake3)(new Uint8Array([
            this.leadbyte,
            ...this.d,
            ...pk_d,
            ...this.valueToBytes(),
...
class NoteEncryption {
    ...
    static generateEsk(seed) {
        return (0, blake3_js_1.blake3)(new Uint8Array([
            ...seed,
    ...
    async chacha20Poly1305Encrypt(plaintext, key) {
        ...
        // Encrypt with AEAD
        const cipher = (0, chacha_js_1.chacha20poly1305)(key, nonce);
...
class NoteEncryptionUtils {
    ...
    static async createEncryptedNote(params) {
        ...
        const h_sig = (0, sha2_js_1.sha256)(rseed);
        ...
        const cv = (0, blake3_js_1.blake3)(new Uint8Array([
