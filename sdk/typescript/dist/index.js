...
class DarkProtocolClient {
    ...
    static async create(config) {
        ...
        config.programId || new PublicKey('3KWLFYco7T2rUZkzjSSthjHGmbWmo9HAsRmvupDTomGC');
     ...
     */
    async getMerkleTree() {
        const [merkleTreePDA] = PublicKey.findProgramAddressSync([Buffer.from('merkle_tree')], this.program.programId);
        // TODO: Implement once IDL is properly generated
        return Promise.resolve({});
    ...
    async getShieldedAddress(owner) {
        const [shieldedAddressPDA] = PublicKey.findProgramAddressSync([Buffer.from('shielded_address'), owner.toBuffer()], this.program.programId);
        // TODO: Implement once IDL is properly generated
    ...
    async getAIAgent(agentPubkey) {
        const [aiAgentPDA] = PublicKey.findProgramAddressSync([Buffer.from('ai_agent'), agentPubkey.toBuffer()], this.program.programId);
        // TODO: Implement once IDL is properly generated
        return Promise.resolve(null);
        /*
        try {
...
export { AIAgentManager, DarkProtocolClient, DarkSwap, DarkSwapDemo, DarkWallet, KNOWN_TOKENS, MEMO_SIZE, NOTEENCRYPTION_AUTH_BYTES, NoteDecryption, NoteEncryption, NoteEncryptionUtils, PROGRAM_IDS, PriceOracle, PrivacyLevel, PrivacyUtils, PrivateSwapManager, RHO_SIZE, RPC_ENDPOINTS, R_SIZE, SAPLING_ADDRESS_SIZE, SAPLING_DIVERSIFIER_SIZE, SAPLING_ENCCIPHERTEXT_SIZE, SAPLING_ENCPLAINTEXT_SIZE, SAPLING_FVK_SIZE, SAPLING_OUTCIPHERTEXT_SIZE, SAPLING_OUTPLAINTEXT_SIZE, SAPLING_SK_SIZE, SaplingExpandedSpendingKey, SaplingFullViewingKey, SaplingHDWallet, SaplingIncomingViewingKey, SaplingNotePlaintext, SaplingOutgoingPlaintext, SaplingPaymentAddress, SaplingSpendingKey, SaplingUtils, TransactionType, VERSION, V_SIZE, base58ToBytes, bytesEqual, bytesToBase58, bytesToHex, calculatePriceImpact, chunk, concatBytes, formatAmount, formatPrice, formatSlippage, getAddressExplorerUrl, getExplorerUrl, getProgramId, getRpcEndpoint, getShieldedWalletId, hexToBytes, isValidAddress, parseAmount, randomBytes, retry, sleep };
