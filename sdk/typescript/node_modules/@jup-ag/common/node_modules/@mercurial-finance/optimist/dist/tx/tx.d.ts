...
export declare const handleSendTransaction: ({ connection, signedTransaction, blockhash, lastValidBlockHeight, idl, skipPreflight, idlProgramId, minContextSlot, }: IHandleSendTransactionOptions) => Promise<IHandleSendTransactionError | IHandleSendTransactionResponse>;
