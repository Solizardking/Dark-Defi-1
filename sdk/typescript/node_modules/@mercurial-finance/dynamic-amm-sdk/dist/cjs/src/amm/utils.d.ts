...
import { AmmProgram, ConstantProductCurve, DepegLido, DepegMarinade, DepegNone, DepegSplStake, PoolFees, PoolInformation, PoolState, StableSwapCurve, SwapQuoteParam, SwapResult, TokenMultiplier } from './types';
...
export declare const calculateSwapQuoteForGoingToCreateMemecoinPool: (inAmountLamport: BN, tokenADepositAmount: BN, tokenBDepositAmount: BN, aToB: boolean, fees: PoolFees, params: SwapQuoteParams2) => {
    amountOut: BN;
    fee: BN;
};
/**
 ...
 */
export declare const calculateSwapQuote: (inTokenMint: PublicKey, inAmountLamport: BN, params: SwapQuoteParam, swapInitiator?: PublicKey) => SwapResult;
/**
...
export declare const deriveProtocolTokenFee: (poolAddress: PublicKey, tokenMint: PublicKey, programId: PublicKey) => PublicKey;
