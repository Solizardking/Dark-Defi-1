...
exports.GoogleGenAIAgent = void 0;
...
class GoogleGenAIAgent {
     ...
     * Initialize agent with system prompt
     */
    async initializeAgent(agentId, wallet) {
...
REASON: [explanation]`;
     ...
     * Analyze portfolio
     */
    async analyzePortfolio(agentId, wallet) {
        const walletState = await wallet.getState();
...
Provide actionable recommendations with confidence scores.`;
     ...
     */
    async getSwapRecommendation(agentId, params) {
...
Recommend the best approach with reasoning.`;
     ...
     */
    async assessRisk(agentId, operation) {
...
Provide a risk score (0-100) and detailed factors.`;
     ...
     */
    async generateStrategy(agentId, params) {
...
exports.GoogleGenAIAgent = GoogleGenAIAgent;
//# sourceMappingURL=google-ai-agent.js.map